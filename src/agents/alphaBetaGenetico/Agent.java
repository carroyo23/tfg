...
public class Agent implements MarioAgent {
	...
	private float VALOR_HORIZONTAL = 835.73157f;
	private float VALOR_VERTICAL = 19.613458f;
	private float VALOR_KILL = 98.53349f;
	private float VALOR_MONEDA = 8.818436f;
